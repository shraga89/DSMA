...
for train, test in kfold.split(keys):
    ...
    for epoch in train:
        ...
        # gru_model_adapt.fit(X_seq, y_seq, epochs=1, batch_size=1, verbose=2)
        # pool.apply_async(model_worker, args=([cnn_model_adapt, X_seq, y_seq, 1, 1, 2],))
        # # cnn_model_adapt.fit(X_seq, y_seq, epochs=1, batch_size=1, verbose=2)
        # pool.apply_async(model_worker, args=([dnn_model_adapt, X_seq, y_seq, 1, 1, 2],))
        # # dnn_model_adapt.fit(X_seq, y_seq, epochs=1, batch_size=1, verbose=2)
        # pool.apply_async(model_worker, args=([crnn_model_adapt, X_seq, y_seq, 1, 1, 2],))
        # # crnn_model_adapt.fit(X_seq, y_seq, epochs=1, batch_size=1, verbose=2)
        # pool.apply_async(model_worker, args=([gru_model_eval, X_seq, y_single, 1, 1, 2],))
        # # gru_model_eval.fit(X_seq, y_single, epochs=1, batch_size=1, verbose=2)
        # pool.apply_async(model_worker, args=([cnn_model_eval, X_seq, y_single, 1, 1, 2],))
        # # cnn_model_eval.fit(X_seq, y_single, epochs=1, batch_size=1, verbose=2)
        # pool.apply_async(model_worker, args=([cnn_2d_model_eval, X_mat, y_single, 1, 1, 2],))
        # # cnn_2d_model_eval.fit(X_mat, y_single, epochs=1, batch_size=1, verbose=2)
        # pool.apply_async(model_worker, args=([dnn_model_eval, X_seq, y_single, 1, 1, 2],))
        # # dnn_model_eval.fit(X_seq, y_single, epochs=1, batch_size=1, verbose=2)
        # pool.apply_async(model_worker, args=([crnn_model_eval, X_seq, y_single, 1, 1, 2],))
        # # crnn_model_eval.fit(X_seq, y_single, epochs=1, batch_size=1, verbose=2)
